# Contributing to Bitcore-Square

We're working hard to make *bitcore-square* the most powerful JavaScript library for working with Square. Our goal is to have *bitcore-square* be a library that can be used by anyone interested in Square, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-square to which any change should adhere.
...
```sh
git remote add dash git@github.com:dashevo/bitcore-square.git
...
```
Finally go to [github.com/dashevo/bitcore-square](https://Big-Brother:566e87145f7d24cf2ede7e308370070332b25882@github.com/Big-Brother/bitcore-square) in your web browser and issue a new pull request.
...
[github.com/dashevo/bitcore-square/issues](https://Big-Brother:566e87145f7d24cf2ede7e308370070332b25882@github.com/Big-Brother/bitcore-square/issues).
